...
/// Stream search within byte-range windows of mmap data.
///
/// For each window, extracts the slice, runs regex.find on it,
/// and converts match offsets back to absolute file positions.
///
/// # Errors
///
/// Returns an I/O error if reading fails.
